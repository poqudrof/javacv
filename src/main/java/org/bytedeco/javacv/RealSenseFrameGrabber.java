...
public class RealSenseFrameGrabber extends FrameGrabber {
    ...
    public void enableColorStream() {
        if (!colorEnabled) {
            ...
            System.out.println("enabling color stream, res:" + imageWidth + "x" + imageHeight + "@" + frameRate);
            colorEnabled = true;
        }
    }
    ...
    public void enableDepthStream() {
        if (!depthEnabled) {
            ...
            System.out.println("enabling depth stream, res:" + depthImageWidth + "x" + depthImageHeight + "@" + depthFrameRate);
            depthEnabled = true;
        }
    }
...
//        if(device.poll_for_frames() == false){
